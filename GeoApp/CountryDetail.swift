...
typealias CountryListDomainModel = CountryDetailDomainModel

struct CountryDetailDomainModel {
    let name: String
...
extension CountryDetailDomainModel: Equatable {
    static func == (lhs: CountryDetailDomainModel, rhs: CountryDetailDomainModel) -> Bool {
